...
public class AccountCardAdapter extends RecyclerView.Adapter<AccountCardAdapter.ViewHolder>{
    ...
    private List<MonthAccount.PayTypeListBean> mDatas;
    ...
    public void setmDatas(List<MonthAccount.PayTypeListBean> mDatas) {
        this.mDatas = mDatas;
    }

    public AccountCardAdapter(Context context, List<MonthAccount.PayTypeListBean> datas){
