...
/** 
 * DAO for table "TOTAL_BILL".
*/
public class TotalBillDao extends AbstractDao<TotalBill, Long> {

    public static final String TABLENAME = "TOTAL_BILL";

    /**
     * Properties of entity TotalBill.<br/>
    ...
    public TotalBillDao(DaoConfig config) {
        super(config);
    }
    
    public TotalBillDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TOTAL_BILL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TOTAL_BILL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TotalBill entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TotalBill entity) {
        stmt.clearBindings();
    ...
    @Override
    public TotalBill readEntity(Cursor cursor, int offset) {
        TotalBill entity = new TotalBill( //
    ...
    @Override
    public void readEntity(Cursor cursor, TotalBill entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TotalBill entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TotalBill entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TotalBill entity) {
